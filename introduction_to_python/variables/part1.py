...
with open('C:/Users/cplei/Documents/GitHub/Python-repo/introduction_to_python/Python/Project_2_Starter/students/part1/data/forecast_5days_a.json') as json_file:
    data = json.load(json_file)
   #print(type(data)) #dictionary
   #print(type(data['DailyForecasts'])) #list

#why is symbol spelled incorrectly.. hmmm.. typo?? 
...
def process_weather(forecast_file): 
    ...
    for forecast in data["DailyForecasts"]:
        ...
        DChancerain.append(forecast['Day']['PrecipitationProbability'])    
        NLongphrase.append(forecast['Night']['LongPhrase'])
        NChancerain.append(forecast['Night']['PrecipitationProbability'])
