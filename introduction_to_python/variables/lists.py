...
tea_collection.extend(["New York", "Berry"])
print(tea_collection)
...
tea_collection = [ 
    ...
    ["Peppermint", "Lemon Ginger", "Strawberry Cream"]
]

print(tea_collection)

print(tea_collection[0][1])#first number for the parent then second number for the child
