...
with open('C:/Users/cplei/Documents/GitHub/Python-repo/introduction_to_python/Python/p2-starter(1)/students/part2/data/forecast_5days_a.json') as json_file:
...
df = {
    "Min_value": [8.3, 10.6, 14.4, 14.4, 10.6],
    "Max_value": [17.8, 19.4, 22.2, 22.2, 18.9],
    "Min_feel_value & Min_shade_value": [5.6, 8.9, 12.8, 12.2, 9.4],
    #"Min_shade_value": [5.6, 8.9, 12.8, 12.2, 9.4],
    "Date": ['Friday 19 June 2020', 'Saturday 20 June 2020', 'Sunday 21 June 2020', 'Monday 22 June 2020', 'Tuesday 23 June 2020']
}
